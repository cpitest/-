...
public enum AdminHeader{
   ヘッダー_法人アカウント_ON($("#admingMenu01on")), //
   ヘッダー_法人アカウント_OFF($("#admingMenu01")), //
   ヘッダー_個別アカウント_ON($("#admingMenu02on")), //
   ヘッダー_個別アカウント_OFF($("#admingMenu02")), //


	;

	private AdminHeader(SelenideElement element) {
