...
public enum BizHeader{
   企業情報_ON($("#isStatusOn")), //
   管理者アカウント($("#isNotAdminAccountOn")), //
   一般アカウント($("#isNotAccountMngOn")), //
   共有ボックス($("#isNotShareBoxOn")), //
   利用状況取得($("#isNotUsageOn")), //
   ファイル管理($("#isNotFileMngOn")), //
   利用規約ダウンロード($("#doLicenseDoc")), //
   ログアウト($("#doLogOut")), //
   ロゴ_ネットワークプリントサービス($("#doSiteTop")), //


	;

	private BizHeader(SelenideElement element) {
