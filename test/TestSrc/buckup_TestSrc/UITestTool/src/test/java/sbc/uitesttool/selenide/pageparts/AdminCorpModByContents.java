...
public enum AdminCorpModByContents{
   ...
   法人種別($("#corpTypeStr")), //
   契約期間($("#contractPeriod")), //
   後課金_コピー機画面カスタマイズ設定_選択($("#appKeyId")), //
   後課金_コピー機画面カスタマイズ設定_追加($("#doSelectAppKeyId")), //
   後課金_コピー機画面カスタマイズ設定_コンテンツ($("#name")), //
   後課金_コピー機画面カスタマイズ設定_削除($("#delAppKeyIdButton")), //
   ...
   キャンセル($("#doCancel")), //
	...
	private AdminCorpModByContents(SelenideElement element) {
