...
public enum BizContentsMng{
   コンテンツの種類_項目($$(Selectors.byText("コンテンツの種類")).first()), //
   コンテンツの種類($("#appKeyId")), //
   すべて解除_上($("#allSelect")), //
   すべて選択_上($("#allCancel")), //
   選択したユーザーを削除_上($("#doDeleteUsers")), //
   新規ユーザーの追加_上($("#doAddUser")), //
   すべて解除_下($("#allSelect2")), //
   すべて選択_下($("#allCancel2")), //
   選択したユーザーを削除_下($("#doDeleteUsers2")), //
   新規ユーザーの追加_下($("#doAddUser2")), //
   ユーザー一覧_項目_ユーザー番号($$(Selectors.byText("ユーザー番号")).first()), //
   ユーザー一覧_項目_ニックネーム($$(Selectors.byText("ニックネーム")).first()), //
   ユーザー一覧_チェックボックス($("#checkbox")), //
   ユーザー一覧_ユーザー番号($("#userCode")), //
   ユーザー一覧_ニックネーム($("#displayName")), //
   ページ選択($("#paginationNo")), //


	;

	private BizContentsMng(SelenideElement element) {
